...
/**
 * @class VFXShip
 * @brief Lecteur runtime d'animations VFX complexes exportees par scene-editormap-vfx.
 *
 * Le pipeline charge:
...
public:
    /**
     * @brief Constructeur runtime VFX complexe attache au navire.
     */
    VFXShip(void);

    /**
     * @brief Destructeur runtime VFX complexe (appelle unload()).
     */
    ~VFXShip(void);
