...
class MinimapParamsButtonWidget {
public:
    MinimapParamsButtonWidget(void);
    ~MinimapParamsButtonWidget(void);

    /**
     * @brief Charge les ressources du bouton params minimap relatif a la minimap.
     */
    void load(void);
    ...
    /**
     * @brief Dessine l'icone params minimap par-dessus la minimap.
     */
    ...
    /**
     * @brief Retourne true si l'icone params minimap a ete cliquee.
     */
...
private:
    ...
    RC2D_Image iconImage;         /**< Texture GPU de l'icone params minimap. */
    RC2D_ImageData iconImageData; /**< Surface CPU de l'icone params minimap. */
};
