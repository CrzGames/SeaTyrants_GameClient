...
// Bundle CA embarqué pour la vérification TLS libcurl en mode cross-platform.
// Source: https://curl.se/ca/cacert.pem
// Fichier généré automatiquement depuis un fichier PEM.
// Compatible MSVC: contenu découpé en plusieurs petits littéraux.
...
inline constexpr std::size_t kClientHttpTlsCaBundlePemSize = sizeof(kClientHttpTlsCaBundlePem) - 1;
