...
{
    this->buffer_.push_back(static_cast<uint8_t>((value >> 8) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>(value & 0xFF));
}

void ByteWriter::writeU32(uint32_t value)
{
    this->buffer_.push_back(static_cast<uint8_t>((value >> 24) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 16) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 8) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>(value & 0xFF));
}
...
{
    this->buffer_.push_back(static_cast<uint8_t>((value >> 56) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 48) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 40) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 32) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 24) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 16) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>((value >> 8) & 0xFF));
    this->buffer_.push_back(static_cast<uint8_t>(value & 0xFF));
...
void ByteWriter::writeBytes(const void* data, size_t size)
{
    ...
    this->buffer_.insert(this->buffer_.end(), bytes, bytes + size);
}
